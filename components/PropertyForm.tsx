    ...
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="p-4 border rounded-md space-y-4">
          ...
          <FormField name="title" label="Título do Anúncio" errors={errors}>
          ...
          <FormField name="description" label="Descrição" errors={errors}>
        ...
        <div className="p-4 border rounded-md space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField name="city" label="Cidade" errors={errors}>
            ...
            <FormField name="neighborhood" label="Bairro" errors={errors}>
        ...
        <div className="p-4 border rounded-md space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <FormField name="price" label="Preço (R$)" errors={errors}><input type="number" name="price" id="price" value={formData.price} onChange={handleChange} className="mt-1 block w-full border-gray-300 rounded-md shadow-sm" /></FormField>
            <FormField name="area" label="Área (m²)" errors={errors}><input type="number" name="area" id="area" value={formData.area} onChange={handleChange} className="mt-1 block w-full border-gray-300 rounded-md shadow-sm" /></FormField>
            <FormField name="bedrooms" label="Quartos" errors={errors}><input type="number" name="bedrooms" id="bedrooms" value={formData.bedrooms} onChange={handleChange} min="0" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm" /></FormField>
            <FormField name="suites" label="Suítes" errors={errors}><input type="number" name="suites" id="suites" value={formData.suites} onChange={handleChange} min="0" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm" /></FormField>
            <FormField name="bathrooms" label="Banheiros" errors={errors}><input type="number" name="bathrooms" id="bathrooms" value={formData.bathrooms} onChange={handleChange} min="0" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm" /></FormField>
            <FormField name="garageSpots" label="Vagas" errors={errors}><input type="number" name="garageSpots" id="garageSpots" value={formData.garageSpots} onChange={handleChange} min="0" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm" /></FormField>
            <FormField name="condoFee" label="Condomínio (R$)" errors={errors}><input type="number" name="condoFee" id="condoFee" value={formData.condoFee} onChange={handleChange} min="0" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm" /></FormField>
            <FormField name="iptu" label="IPTU (R$)" errors={errors}><input type="number" name="iptu" id="iptu" value={formData.iptu} onChange={handleChange} min="0" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm" /></FormField>
          </div>
...
const FormField: React.FC<{ name: keyof FormData, label: string, children: React.ReactNode, errors: Partial<Record<keyof FormData | 'images', string>> }> = ({ name, label, children, errors }) => (
  <div>
